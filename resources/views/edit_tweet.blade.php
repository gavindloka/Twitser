...
<div class="tweet">
    <div class="tweet__main">
        ...
        <div class="tweet__content">
            ...
            <form action="{{route('update_tweet',$post->post_id)}}" method="post">
                @csrf
                @method('put')
                <div class="my-1 p-3 bg-body rounded shadow-sm">
                    <div class="mb-3 row">
                        <div class="col-sm-10 d-flex justify-content-center align-items-center">
                            <input type="text" class="form-control" name="content" id="content" placeholder="Edit your tweet" style="width: 50em; height: 10em;">
                            @error('content')
