  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{route('home')}}" style="font-weight: bold">Home</a>
        </li>
        <li class="nav-item">
...
@include('SubmitTweet/submit_post')
...
<div class="tweet">
    <div class="tweet__main">
        ...
        <div class="tweet__header">
            ...
            <a href="{{route('edit_tweet',$post->post_id)}}" style="margin-left:20px">Edit</a>
            <a href="{{route('show_tweet',$post->post_id)}}" style="margin-left:20px">View</a>
        </div>
